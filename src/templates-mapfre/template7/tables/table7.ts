import { Paragraph, Table, TableCell, TableRow, WidthType, HeightRule, ShadingType, VerticalAlign, TextRun, AlignmentType } from "docx";
...
export class Table7 {
    ...
    create(): Table {
        ...
        if (this.business.mainCustomers.length > 0) {
            this.business.mainCustomers.forEach((element, index) => {
                if (index == 0) {
                    row[0] = new TableRow({
                        height: heightRow2,
                        children: [
